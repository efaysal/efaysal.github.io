...
my @AZ=(rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand());
my @CZ=(rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand());
  ...
  if ($order1 == 1)
      ...
      for $indexZ (0..$lengthZ - 1)
	{
	  if ($indexZ == 0)
	    ...
	    {
	      $conjC[$indexZ] = 'CJ' . $C[$indexZ];
	      $conjD[$indexZ] = 'CJ' . $D[$indexZ];
	    }
	}
      my @cay1 = cayley(\@A, \@C);
